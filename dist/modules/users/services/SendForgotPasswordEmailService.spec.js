...
describe('SendForgotPasswordEmail', function () {
    ...
    it('should be able to recove the password using the email', function () { return __awaiter(void 0, void 0, void 0, function () {
        var sendMail;
    ...
    it('should generate a forgot password token', function () { return __awaiter(void 0, void 0, void 0, function () {
        var gerenateToken, user;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    gerenateToken = jest.spyOn(fakeUserTokensRepository, 'generate');
                    return [4 /*yield*/, fakeUsersRepository.create({
                            name: 'John Doe',
                            email: 'johndoe@example.com',
                            password: '123456',
